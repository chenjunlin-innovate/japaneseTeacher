...
WordStudyUI::WordStudyUI(QWidget *parent) : QWidget(parent)
{
    ...
    QLabel *chinese=new QLabel(this);
    ...
    QPushButton *firstButton=new QPushButton(this);
    ...
    QPushButton *nextword=new QPushButton(this);
